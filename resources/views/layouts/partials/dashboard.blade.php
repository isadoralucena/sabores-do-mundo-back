                ...
                <div id="recipe-dashboard" class="d-flex align-items-center">
                    <div id="pic-dashboard">
                      @if($recipe->photo_path)
                        <img src="{{ asset('storage/' . $recipe->photo_path) }}" class="img-fluid zoom" id="pic-d" alt="Imagem da Receita">
                      @else
                        <img src="assets/img/generic.jpg" class="img-fluid zoom" id="pic-d">
                      @endif
                    </div>
