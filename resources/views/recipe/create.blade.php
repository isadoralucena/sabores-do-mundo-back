...
@section('title', 'Criar receita - Sabores do mundo')
...
@section('content')
    ...
    <div class="container" style="border: 1px solid gray; border-radius: 10px; padding: 20px 20px 0px 20px;">
        <form action="{{ route('recipe.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
            @csrf
            <!-- Lado Esquerdo -->
            <div class="col-md-6">
                <div class="mb-3">
                  <label for="selecionar-imagem">
                    <h2>Capa da Receita</h2>
                      <div id="selecionar-imagem" onclick="document.getElementById('inputImagem').click()">
                          ...
                          <img id="miniatura" alt="Miniatura">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <h2>Instruções</h2>
                    <textarea name="instructions" class="form-control" rows="12"></textarea>
                </div>
            </div>
            <!-- Botão de Envio -->
            <div class="col-md-12">
